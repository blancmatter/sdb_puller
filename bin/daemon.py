#!/usr/bin/env python3
"""
DAR 26/06/19 --> Code taken from the following link and modified for python3 syntax
https://gist.github.com/dcai/1075904/6f7be00f7f411d5c2e7cd1691dcbb68efacb789c#file-daemon-py
"""
...
class Daemon:
    ...
    def debug(self):
        # Run the commands without daemonising to get terminal feedback
        self.run()
