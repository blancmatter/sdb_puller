...
#define UCT_CNT1    (1<<2)
#define UCT_CNT2    (1<<3)
#define UCT_STATUS  (1<<4)
#define UCT_COUNT   (1<<5)
#define UCT_NULLCNT (1<<6)
#define UCT_OUTPUT  (1<<7)
...
#define UCTREAD_CFW     (1<<8)
#define UCTREAD_UCT0    (0)
#define UCTREAD_UCT1    (1<<9)
#define UCTREAD_UCT2    (2<<9)
#define UCTREAD_0BYTES  (0)
#define UCTREAD_1BYTE   (1<<11)
#define UCTREAD_2BYTES  (2<<11)
#define UCTREAD_3BYTES  (3<<11) 
